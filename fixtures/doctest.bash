...
# install doctest
run_cmd_if $((! GHCJSARITH && HCNUMVER >= 80000)) $CABAL v2-install $ARG_COMPILER --ignore-project -j doctest --constraint='doctest ^>=0.22.0'
run_cmd_if $((! GHCJSARITH && HCNUMVER >= 80000)) doctest --version
...
# doctest
put_info "doctest"
change_dir_if $((! GHCJSARITH && HCNUMVER >= 80000)) ${PKGDIR_splitmix}
run_cmd_if $((! GHCJSARITH && HCNUMVER >= 80000)) doctest  -XHaskell2010 src src-compat
