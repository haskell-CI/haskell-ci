...
genTravisFromCabalFile (argv,opts) fn xpkgs = do
    ...
    putStrLn "# This Travis job script has been generated by a script via"
    putStrLn "#"
    putStrLn ("#   make_travis_yml_2.hs " ++ unwords [ "'" ++ a ++ "'" | a <- argv ])
    putStrLn "#"
    putStrLn "# For more information, see https://github.com/hvr/multi-ghc-travis"
    putStrLn "#"
    putStrLn "language: c"
    putStrLn "sudo: false"
    putStrLn ""
    putStrLn "git:"
    putStrLn "  submodules: false  # whether to recursively clone submodules"
    putStrLn ""

    unless (optNoCache opts) $ do
        putStrLn "cache:"
